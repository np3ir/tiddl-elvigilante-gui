...
so it is deliberately NOT duplicated. 1.0.22 is pinned to engine **v1.5.4**.
...
# ---------------------------------------------------------------------------
def test_app_version_single_module_assignment_is_1_0_22():
...
# ---------------------------------------------------------------------------
_DUP_APP_VERSION = 'APP_VERSION = "1.0.22"\nAPP_VERSION = "9.9.9"\n'
